...
class TestReport(common.TransactionCase):
    """
    Basic tests to validate rendering, attachment saving, and object retrieval.
    """
    def setUp(self):
        super().setUp()
        self.report_object = self.env["ir.actions.report"]
        self.xlsx_report = self.env["report.kaz_report_xlsx.abstract"].with_context(
            active_model="res.partner"
        )
        self.report_name = "kaz_report_xlsx.partner_xlsx"
