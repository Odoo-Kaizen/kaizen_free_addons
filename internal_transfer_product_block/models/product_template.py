...
class ProductTemplate(models.Model):
    ...
    temp_block_note = fields.Char(
        string='Note', 
        required=False, default='Blocking this product template will block all its variants', readonly=True)
    temp_warehouse_note = fields.Char(
        string='',
        required=False, readonly=True, default='Empty blocked warehouses value means blocking from all warehouses')
